...
public enum PlatformEntity {
    ...
    WEIBO(4, "新浪微博", 1, R.drawable.logo_sinaweibo, 4, true); //
  //  MESSAGER(10, "短信", 1, R.drawable.messager, 5, true);//
    ...
    PlatformEntity(int id, String name, int version, int icon, int index, boolean enable) {
        this.id = id;
        this.name = name;
    ...
    public PlatformEntity setIndex(int index) {
        this.index = index;
        return this;
    }

    public PlatformEntity setAppKey(String appKey) {
        this.appKey = appKey;
        return this;
    }

    public PlatformEntity setAppSecret(String appSecret) {
        this.appSecret = appSecret;
        return this;
    }
    public PlatformEntity setRedirectUrl(String redirectUrl) {
